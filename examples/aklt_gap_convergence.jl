using MPSKit, TensorKit, MPSKitExperimental, MPSKitModels, KrylovKit, Plots
let
    ...
    plot(variances,real.(energies).-real(2*aklt_gap),legend=false, seriestype=:scatter,xaxis="variance",yaxis = "E(0) - 2E(pi)")
